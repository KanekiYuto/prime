    ...
    */
    ...
    'connections' => [
        ...
        'master-mysql' => [
            ...
            'database' => env('MASTER_DB_DATABASE', 'laravel'),
        ...
        'laravel-mysql' => [
            ...
            'database' => env('LARAVEL_DB_DATABASE', 'laravel'),
            'username' => env('LARAVEL_DB_USERNAME', 'root'),
            'password' => env('LARAVEL_DB_PASSWORD', ''),
            'unix_socket' => env('LARAVEL_DB_SOCKET', ''),
            'charset' => env('LARAVEL_DB_CHARSET', 'utf8mb4'),
            'collation' => env('LARAVEL_DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
